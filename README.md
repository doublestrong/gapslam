...
This is the codebase for the GAPSLAM paper. We provide the code and examples about the algorithms described in the paper. This work aims to infer marginal posteriors of robot poses and landmark locations encountered in SLAM via real-time operation. A teaser video about the work:
